...
var cbpBGSlideshow=function(){function n(){t=$("#cbp-bislideshow"),o=t.children("li"),p=o.length,r=$("#cbp-bicontrols"),d=!0,b={$navPrev:r.find("span.cbp-biprev"),$navNext:r.find("span.cbp-binext"),$navPlayPause:r.find("span.cbp-bipause")},t.imagesLoaded(function(){Modernizr.backgroundsize?o.each(function(){var n=$(this);n.css("background-image","url("+n.find("img").attr("src")+")")}):t.find("img").show(),o.eq(l).css("opacity",1),i(),a(),t.trigger("slide-init",o.eq(l))})}function i(){b.$navPlayPause.on("click",function(){var n=$(this);n.hasClass("cbp-biplay")?(n.removeClass("cbp-biplay").addClass("cbp-bipause"),a()):(n.removeClass("cbp-bipause").addClass("cbp-biplay"),c())}),b.$navPrev.on("click",function(){e("prev"),u&&c()}),b.$navNext.on("click",function(){e("next"),u&&c()})}function e(n){if(d){d=!1;var i=o.eq(l);"next"===n?l=p-1>l?++l:0:"prev"===n&&(l=l>0?--l:p-1);var e=o.eq(l);i.css("opacity",0),e.animate({opacity:1},function(){setTimeout(function(){d=!0},1e3)}),t.trigger("slide-change",o.eq(l))}}function a(){u=!0,clearTimeout(s),s=setTimeout(function(){e("next"),a()},v)}function c(){u=!1,clearTimeout(s)}var s,t=$("#cbp-bislideshow"),o=t.children("li"),p=o.length,r=$("#cbp-bicontrols"),b={$navPrev:r.find("span.cbp-biprev"),$navNext:r.find("span.cbp-binext"),$navPlayPause:r.find("span.cbp-bipause")},l=0,u=!0,d=!0,v=5e3;return{init:n}}();
